...
alert = vlc.MediaPlayer(r"C:\\Users\\appua\\OneDrive\Desktop\driverdrovness\driver-drowsiness-detection-master\driver-drowsiness-detection-master\\take_a_break.mp3")
frame_thresh = 15
close_thresh = 0.2#(close_avg+open_avg)/2.0
flag = 0
